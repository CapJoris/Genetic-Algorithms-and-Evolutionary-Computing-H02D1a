...
To run a simple benchmark of the problem with path representation, run benchmark.m, this will run the belgian tour problem with pre configured settings. To change settings or the problem, edit benchmark.m and fill in the desired parameter values, however only path representation should be used for the demonstrations.
