...
x=data(:,1);y=data(:,2);%/max([data(:,1);data(:,2)])
NVAR=size(data,1);
...
mutation = uicontrol(ph,'Style','popupmenu', 'String',{'inversion','insertion'}, 'Value',1,'Position',[180 50 130 20],'Callback',@mutation_Callback);
...
crossover = uicontrol(ph,'Style','popupmenu', 'String',{'xalt_edges','OX'}, 'Value',1,'Position',[10 50 130 20],'Callback',@crossover_Callback);
