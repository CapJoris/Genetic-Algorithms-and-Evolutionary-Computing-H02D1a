function [best, mean_fits, worst, gen, path] = run_tsp(x, y, NIND, MAXGEN, NVAR, ELITIST, STOP_PERCENTAGE, PR_CROSS, PR_MUT, CROSSOVER, MUTATION, LOCALLOOP)
% usage: run_ga(x, y, 
%               NIND, MAXGEN, NVAR, 
...
%test
        ...
        [~,bestInd]=min(ObjV);
        path = [[x(Chrom(bestInd,:)); x(Chrom(bestInd,1))],[y(Chrom(bestInd,:)); y(Chrom(bestInd,1))]];        
end
