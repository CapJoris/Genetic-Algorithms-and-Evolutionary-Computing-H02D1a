function [best, mean_fits, worst, gen] = run_tsp(x, y, NIND, MAXGEN, NVAR, ELITIST, STOP_PERCENTAGE, PR_CROSS, PR_MUT, CROSSOVER, MUTATION, LOCALLOOP)
% usage: run_ga(x, y, 
%               NIND, MAXGEN, NVAR, 
